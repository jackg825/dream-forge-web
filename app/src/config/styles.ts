...
export const STYLE_CONFIGS: Record<StyleId, StyleConfig> = {
  ...
  bobblehead: {
    ...
    previewImages: [
      '/styles/bobblehead/preview-1.jpg',
      '/styles/bobblehead/preview-2.jpg',
      '/styles/bobblehead/preview-3.jpg',
      '/styles/bobblehead/preview-4.jpg',
      '/styles/bobblehead/preview-5.jpg',
      '/styles/bobblehead/preview-6.jpg',
    ],
    characteristics: {
      headRatio: '3-4x 身體大小',
      bodyStyle: '小巧緊湊，有底座',
  ...
  chibi: {
    ...
    previewImages: [
      '/styles/chibi/preview-1.jpg',
      '/styles/chibi/preview-2.jpg',
      '/styles/chibi/preview-3.jpg',
      '/styles/chibi/preview-4.jpg',
      '/styles/chibi/preview-5.jpg',
      '/styles/chibi/preview-6.jpg',
    ],
    characteristics: {
      headRatio: '2-3 頭身比例',
      bodyStyle: '圓潤短小的四肢',
  ...
  cartoon: {
    ...
    previewImages: [
      '/styles/cartoon/preview-1.jpg',
      '/styles/cartoon/preview-2.jpg',
      '/styles/cartoon/preview-3.jpg',
      '/styles/cartoon/preview-4.jpg',
      '/styles/cartoon/preview-5.jpg',
      '/styles/cartoon/preview-6.jpg',
    ],
    characteristics: {
  ...
  emoji: {
    ...
    previewImages: [
      '/styles/emoji/preview-1.jpg',
      '/styles/emoji/preview-2.jpg',
      '/styles/emoji/preview-3.jpg',
      '/styles/emoji/preview-4.jpg',
      '/styles/emoji/preview-5.jpg',
      '/styles/emoji/preview-6.jpg',
    ],
    characteristics: {
      headRatio: '頭即身體（球形）',
      bodyStyle: '極簡幾何形狀',
