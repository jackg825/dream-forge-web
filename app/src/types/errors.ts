...
export const ERROR_CODES = {
  ...
  HUNYUAN_RATE_LIMIT: 'HUNYUAN_RATE_LIMIT',
  TRIPO_RATE_LIMIT: 'TRIPO_RATE_LIMIT',
  ...
  HUNYUAN_SERVICE_ERROR: 'HUNYUAN_SERVICE_ERROR',
  TRIPO_SERVICE_ERROR: 'TRIPO_SERVICE_ERROR',
...
export const ERROR_PATTERNS: ErrorPattern[] = [
  ...
  // Hunyuan service errors (must be before generic mesh error)
  {
  ...
  // Tripo service errors (must be before generic mesh error)
  {
  ...
  // Meshy service errors (only matches explicit "meshy" keyword)
  {
