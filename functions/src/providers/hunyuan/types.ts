...
export const HUNYUAN_API_HOST = 'ai3d.tencentcloudapi.com';
export const HUNYUAN_API_VERSION = '2025-05-13';
export const HUNYUAN_SERVICE = 'ai3d';
 ...
 */
export const HUNYUAN_QUALITY_FACE_COUNT: Record<string, number> = {
  draft: 40000,
  standard: 200000,
  fine: 500000,
};
