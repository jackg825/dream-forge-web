...
export interface CreatePaymentIntentResult {
  success: boolean;
  clientSecret?: string;      // For frontend confirmation (Stripe)
  transactionId?: string;     // Our internal reference
  redirectUrl?: string;       // For redirect-based payments (PayPal, Alipay)
  error?: string;
}
