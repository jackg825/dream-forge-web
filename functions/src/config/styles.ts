 ...
 */
export function isValidStyleId(value: string | undefined): value is StyleId {
  return value !== undefined && STYLE_IDS.includes(value as StyleId);
}
...
export function getStyleConfig(styleId: StyleId | undefined): StyleConfig {
  return STYLE_CONFIGS[styleId || DEFAULT_STYLE];
}
