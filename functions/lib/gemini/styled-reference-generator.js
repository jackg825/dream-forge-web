...
exports.generateStyledReference = generateStyledReference;
 ...
 */
function getViewAngleDescription(angle) {
    const descriptions = {
 ...
 */
async function generateStyledReference(referenceImageBase64, mimeType, options) {
    ...
    if (!analysis.hasImage) {
        const textInfo = analysis.textContent
            ...
            : '';
        throw new functions.https.HttpsError('internal', `No image returned from Gemini for styled reference.${textInfo}`);
    }
    // Extract image data
...
//# sourceMappingURL=styled-reference-generator.js.map