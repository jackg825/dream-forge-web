 ...
 */
export type NotificationChannel = 'webhook' | 'email' | 'sms' | 'push';
/**
...
export interface INotificationServiceFactory {
     ...
     */
    notifyAll(content: NotificationContent, recipient: NotificationRecipient): Promise<NotificationResult[]>;
}
/**
