 ...
 */
import { Order, AdminOrder, OrderStatus, ShippingAddress, PrintMaterial, PrintSizeId, MaterialConfig, SizeConfig, ColorOption } from '../order/types';
/**
...
export interface IOrderRepositoryTransaction {
     ...
     */
    runTransaction<T>(fn: (repository: IOrderRepository) => Promise<T>): Promise<T>;
}
